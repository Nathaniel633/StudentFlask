...
class User(db.Model):
    ...
    def __init__(self, name, uid, password="123qwerty", dob=date.today(), email="nulll@gmail.com"):
...
def initUsers():
    with app.app_context():
        ...
        u1 = User(name='Thomas Edison', uid='toby', password='123toby', dob=date(1847, 2, 11), email='tedison@generalelectric.com')
